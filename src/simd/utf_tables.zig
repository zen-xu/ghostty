// These are the UTF8 tables from the simdutf project:
// https://github.com/simdutf/simdutf (MIT licensed)

pub const shufutf8: [209][16]u8 = .{
...
pub const utf8bigindex: [4096][2]u8 = .{
    .{ 209, 12 },
    .{ 209, 12 },
    .{ 209, 12 },
    .{ 209, 12 },
