...
pub fn threadEnter(self: *Termio, thread: *termio.Thread) !ThreadData {
...
/// Clear the screen.
pub fn clearScreen(self: *Termio, history: bool) !void {
    {
        self.renderer_state.mutex.lock();
        defer self.renderer_state.mutex.unlock();
...
pub inline fn queueWrite(self: *Termio, data: []const u8, linefeed: bool) !void {
    const ev = self.data.?;
